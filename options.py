...
class Options:
    def __init__(self):
        ...
        self.parser.add_argument('--tgt_folder_name', type=str, default=None)
        self.parser.add_argument('--output_vid_name', type=str, default='final_outcome')
        ...
        self.parser.add_argument('--lambda_pos', type=float, default=1)
        self.parser.add_argument('--lambda_motion', type=float, default=1)
